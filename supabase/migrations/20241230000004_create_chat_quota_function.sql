-- Create check_chat_quota function
-- Created: December 30, 2024
-- Purpose: Enforce AI chat limits per tier (with grandfathering for beta users)
...
BEGIN
  ...
  -- If no subscription found, deny (shouldn't happen)
...
-- Add helpful comment
COMMENT ON FUNCTION check_chat_quota IS 'Checks if user can send more AI chats this month. Beta users (grandfathered) get unlimited.';
