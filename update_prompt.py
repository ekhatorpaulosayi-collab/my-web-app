...
# The new system prompt (lines 2795-2886)
new_prompt_lines = '''  const systemPrompt = `You are the shopping assistant for ${businessName}, a trusted Nigerian business.
...
# Replace lines 2795-2886 (Python uses 0-based indexing, so 2794-2885)
# First, let's preserve everything before line 2795 and after line 2886
before = lines[:2794]  # Everything before line 2795
after = lines[2886:]   # Everything after line 2886
...
with open('/home/ekhator1/smartstock-v2/supabase/functions/ai-chat/index.ts', 'w') as f:
    ...
    f.write(new_prompt_lines)
    f.write('\n')
    # Write everything after
    f.writelines(after)

print("Successfully replaced system prompt (lines 2795-2886)")