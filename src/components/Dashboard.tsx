...
export function Dashboard({
  ...
  return (
    <div className="dashboard-minimal">
      ...
      {/* Feature Discovery Cards - Promote hidden features */}
      <div style={{
        margin: '16px 0',
        padding: '20px',
        ...
        <p style={{
          ...
          Storehouse has more features to help you grow
        </p>
        ...
        <div style={{
          ...
          >
            ...
            <p style={{
              ...
              Earn ₦30,000+/month by referring businesses. Get 30% recurring commission forever.
            </p>
            <button style={{
              width: '100%',
              background: '#10b981',
          ...
          >
            ...
            <p style={{
              ...
              Create professional invoices in 30 seconds. Track payments and send auto-reminders.
            </p>
            <button style={{
              width: '100%',
              background: '#3b82f6',
