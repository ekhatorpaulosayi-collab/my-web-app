...
Storehouse tracks progress and cheers you on! 🎯`,
  ...
  // STAFF MANAGEMENT
  // ============================================
  // NOTE: Staff management documentation has been moved to staffMicroChunks.js
  // for better RAG retrieval and accuracy. The micro-chunks are based on
  // ACTUAL Storehouse code (StaffManagement.tsx, StaffPinLogin.tsx, StaffContext.tsx).
  //
